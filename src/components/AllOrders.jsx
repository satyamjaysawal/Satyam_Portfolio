...
const AllOrders = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      {error && (
        <div className="max-w-7xl mx-auto mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded">
          <p className="text-red-700">{error.toString()}</p>
        </div>
      )}

      {successMessage && (
        <div className="max-w-7xl mx-auto mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded">
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="font-medium text-gray-900">ID: {order.user_id}</p>
                    </div>
                    <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <p className="font-medium text-gray-900">{order.tracking_id || 'Not available'}</p>
                    </div>
                  </div>
